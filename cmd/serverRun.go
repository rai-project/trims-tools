...
func init() {
	...
	serverRunCmd.Flags().Float32Var(&runServerModelEstimationRate, "model_estimation_rate", 3.0, "File size multiplier used to determine how much memory would be used by a model")
