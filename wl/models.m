...
prettyNameMapping = <|
     ...
     "locationnet_1.0"->"LocationNet", "network_in_network_1.0"->"NIN-v1",
     "o_resnet101_2.0"->"o-ResNet101-v2", "o_resnet152_2.0"->"ResNet152-v2",
     "o_vgg16_1.0"->"o-VGG16", "o_vgg19_1.0"->"o-VGG19",
     "resnet101_1.0"->"ResNet101-v1", "resnet101_2.0"->"ResNet101-v2",
     "resnet152_1.0"->"ResNet152-11k-v1", "resnet152_11k_1.0"->"ResNet152-11k",
     ...
     "resnet50_2.0"->"ResNet50-v2", "resnext101_1.0"->"ResNeXt101-v1",
     ...
     "vgg16_1.0"->"VGG16-v1", "vgg16_sod_1.0"->"VGG16_SOD",
     "vgg16_sos_1.0"->"VGG16_SOS", "vgg19_1.0"->"VGG19", "wrn50_2.0"->"WRN50-2",
