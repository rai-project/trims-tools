...
prettyNameMapping = <|
     ...
     "o_vgg19_1.0"->"o-VGG19",
     "ResNet101" -> "ResNet101",
     "resnet101_1.0"->"ResNet101",
     "resnet101_2.0"->"ResNet101-v2",
     "resnet152_1.0"->"ResNet152",
     "ResNet152" -> "ResNet152",
...
<|"BVLC-AlexNet" -> 1, "BVLC-GoogLeNet" -> 2,
 ...
 "Inception-ResNet-v2" -> 11, "LocationNet" -> 12, "NIN" -> 13,
 "ResNet101" -> 14, "ResNet101-v2" -> 15, "ResNet152" -> 16,
  "ResNet152-11k" -> 17, "ResNet152-v2" -> 18, "ResNet18-v2" -> 19,
 "ResNet200-v2" -> 20, "ResNet269-v2" -> 21, "ResNet34-v2" -> 22,
 "ResNet50-v2" -> 24, "ResNeXt101" -> 25, "ResNeXt101-32x4d" -> 26,
  "ResNeXt26-32x4d" -> 27, "ResNeXt50" -> 28, "ResNeXt50-32x4d" -> 29,
  "SqueezeNet-v1.0" -> 30, "SqueezeNet-v1.1" -> 31, "VGG16" -> 32,
